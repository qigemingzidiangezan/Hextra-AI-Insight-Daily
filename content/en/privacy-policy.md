...
We utilize your personal data to provide and enhance the Service. By using the Service, you agree to our collection and use of information in accordance with this Privacy Policy.

## Interpretation and Definitions

### Interpretation
Capitalized words, under the following conditions, carry defined meanings. Regardless of their appearance in singular or plural form, the definitions provided below maintain the same meaning.
...
#### Personal Data
When utilizing our Service, we may request that you provide certain personally identifiable information. This information can be used to contact or identify you and may include, but is not limited to:
...
When you access the Service using a mobile device, we may automatically collect certain information. This can include, but is not limited to, the type of mobile device you use, your mobile device's unique ID, your mobile device's IP address, your mobile operating system, the type of mobile Internet browser you use, unique device identifiers, and other diagnostic data.
...
We employ Cookies and similar tracking technologies to monitor activity on our Service and store specific information. The tracking technologies utilized include beacons, tags, and scripts, which serve to collect and track information, as well as to improve and analyze our Service. The technologies we use may include:
...
- **Functionality Cookies**
  - **Type**: Persistent Cookies
  - **Managed by**: Us
  - **Purpose**: These Cookies enable us to remember choices you make when you use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide you with a more personalized experience and to avoid you having to re-enter your preferences every time you use the Website.
...
- **For providing and maintaining our Service**, including monitoring its usage.
...
Prior to the changes becoming effective, We will inform You via email and/or a prominent notice on Our Service, and update the "Last updated date" at the top of this Privacy Policy.
